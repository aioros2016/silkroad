<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="b_applist.aspx.cs" Inherits="OPD2C.SilkRoad.Site.b.b_applist" %>
                            ...
                            <div class="min-width-box clearfix">
                                <div class="main">
                                    <div class="top-bar" ng-hide="nowCate == -1 ? true : false">
                                        <div class="category">
                                            <ul>
                                                 <li class="active"><a href="b_applist.aspx?type=tobapp">游戏</a></li>
                                        ...
                                        <div class="sort-box" ng-show="false">
                                            <div class="search">
                                                <input type="text" />
                                                <div class="icon-search"><i class="iconfont icon-sousuo"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="list">
                                                <ul>
                                                    <li ng-repeat="app in appList">
														<a class="item-box" href="b_appdetail.aspx?aid={{app.id}}">
															<div class="cover"><img ng-src="{{app.icon == '' ? '/images/no_cover.png' : app.icon}}" /></div>
															<div class="info">
																<p>类型：<span>{{app.type}}</span></p>
																<p>阶段：{{app.phase}}</p>
																<p>平台：<span>{{app.platforms}}</span></p>
																<p>需求：<span>{{app.need}}</span></p>
															</div>
														</a>
													</li>
                                                </ul>
